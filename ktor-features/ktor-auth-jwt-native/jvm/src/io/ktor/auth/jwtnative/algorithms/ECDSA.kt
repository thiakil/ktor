...
import io.ktor.auth.jwtnative.InvalidSignatureException
import io.ktor.util.*
...
private fun JsonWebKey.EllipticCurve.toJavaPublic(): ECPublicKey {
...
private fun JsonWebKey.EllipticCurve.toJavaPrivate(): ECPrivateKey {
