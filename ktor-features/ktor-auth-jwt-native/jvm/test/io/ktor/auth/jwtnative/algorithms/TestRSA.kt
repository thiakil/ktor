...
class TestRSA {
    ...
    fun testSignAndVerify(){
        ...
        val signed = runBlocking { JWS.sign(baseToken, RS256, { JavaPrivateRSAKey(getPrivateKey() as RSAPrivateKey) }) }
        assertTrue(RS256.verify(JWT.decode(signed).signature!!, JavaPublicRSAKey(getPublicKey() as RSAPublicKey)))
    }
